...
export default function Banner() {
  ...
  const handleDelete = async (id) => {
    ...
    if(flag){
     await axios.delete(`https://actl.co.in/suchit/deletebanner/${id}`);
     getProfile()
    }
  };
        ...
        <tbody>
          {data.map((product, index) => (
            <tr key={index} className="border-t border-gray-200">
              ...
              <td className="py-2 px-4"><img src={`https://actl.co.in/suchit_uploads/${product.banner}`} alt="" className='w-96'/></td>
