...
export default function DashboardShow({ title, value, onViewMore }) {
  ...
  async function getProfile() {
   ...
   let delivered = order.data.filter(product => product.status === 'Delivered')
        setData({ productLength: result.data.length, categoryLuchith: responce.data.length,subCategoryLength:res.data.length,pendingOrder: pending.length, deliveredOrder:delivered.length })
