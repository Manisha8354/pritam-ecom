...
console.log(data)
  ...
  const handleDelete = async (id) => {
    ...
    if(flag){
     await axios.delete(`https://actl.co.in/suchit/subcategorydelete/${id}`);
      getProfile()
    }
  };
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {data.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><img src={`https://actl.co.in/suchit_uploads/${item.subcategoryImage}`} alt="" className='h-20 w-20'/></td>
