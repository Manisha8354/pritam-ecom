                    ...
                    <div className="md:w-1/2 md:ml-8 mt-8 md:mt-0">
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                "In addition to fashion, we are proud to offer an extensive selection of home appliances tailored to meet the evolving needs of modern living. Our energy-efficient coolers and eco-friendly appliances are designed to enhance your home while keeping your carbon footprint in check. Whether it’s staying cool with our powerful yet silent fans or reducing energy consumption, we aim to blend technology with sustainability. At Brohh, every detail—from your wardrobe to your home—is a step towards living naturally, beautifully, and responsibly.",
